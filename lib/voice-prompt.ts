...
export function buildVoiceInstructions({
  ...
  parts.push(`- ACENTO: Habla en ESPAÑOL LATINOAMERICANO neutro (acento peruano/latino, NUNCA acento español de España).`)
  parts.push(`- No uses "vosotros" ni "tildes españolas". Usa "ustedes", "tú", como en Latinoamérica.`)
  parts.push(`- Pronuncia "z" y "ce/ci" como "s" (seseo latino), no como "th" español.`)
  parts.push(`- Velocidad: clara y pausada.`)
